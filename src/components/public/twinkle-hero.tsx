...
export function TwinkleHero() {
  return (
    <section className="relative overflow-hidden rounded-[20px] bg-white dark:bg-[#151c28] p-6 sm:p-8 lg:p-10 border border-[#e6e6e6] dark:border-white/10 shadow-xs transition-colors duration-200">
      {/* Zero-Overhead Pre-Blended Radial Glows (No CSS filter blur) */}
      <div
      ...
      <div className="relative z-10 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <Link href="/schedules">
                <button className="group inline-flex items-center gap-2 rounded-full bg-[#007aff] hover:bg-[#0062cc] active:scale-[0.98] text-white px-5 py-2.5 text-xs sm:text-sm font-semibold transition-all shadow-xs cursor-pointer">
          ...
          <div className="lg:col-span-5 flex items-center justify-center relative select-none">
            <div className="relative w-full max-w-sm flex items-center justify-center py-3">
              {/* Zero-Overhead Ambient Backing (Pre-blended radial) */}
              <div
                className="absolute inset-0 rounded-full pointer-events-none opacity-40 dark:opacity-30 transform scale-90"
                style={{
                  background: 'radial-gradient(circle, rgba(0, 122, 255, 0.18) 0%, rgba(175, 82, 222, 0.12) 40%, transparent 70%)',
                }}
              />
              ...
              <div
                className="absolute -top-1 -right-2 z-20 flex items-center gap-1.5 rounded-full bg-white/95 dark:bg-[#1c2433]/95 text-[#007aff] dark:text-[#60a5fa] border border-[#007aff]/25 dark:border-[#007aff]/30 px-3.5 py-1 text-xs font-semibold shadow-xs cursor-default animate-float-1"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-[#e6e6e6] dark:border-white/10">
          {/* Card 1: MOOC & TMO */}
          <div className="rounded-[14px] bg-white dark:bg-[#141b27] border border-[#e6e6e6] dark:border-white/10 shadow-2xs overflow-hidden flex flex-col justify-between hover:border-[#007aff]/60 dark:hover:border-[#007aff]/60 hover:-translate-y-1 hover:shadow-xs transition-all duration-200">
