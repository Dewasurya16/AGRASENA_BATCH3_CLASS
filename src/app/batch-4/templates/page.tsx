...
export const metadata = {
  title: "Pusat Download Template Dokumen TIK & DUPAK — Diklat Prakom Batch 4 Kejaksaan RI",
  description: "Download format resmi SPT Pemeliharaan TI, Formulir DUPAK & SPMK, SOP Ruang Server, Berita Acara Kerusakan TIK, dan Format Makalah Seminar untuk Batch 4.",
}

export default function Batch4TemplatesPage() {
  return (
    <PublicShell>
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="rounded-[16px] bg-emerald-50/80 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/60 p-3.5 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-2xs">
          <div className="flex items-center gap-2.5">
            ...
            <div className="text-xs">
              <span className="font-bold text-emerald-950 dark:text-emerald-200">
                Pusat Template Dokumen & DUPAK: Agrasena Batch 4.
              </span>{" "}
              <span className="text-emerald-800/80 dark:text-emerald-300/80">
                Format resmi SPT, administrasi angka kredit, dan berkas seminar Diklat Prakom Kejaksaan RI.
              </span>
            </div>
          </div>
          <Link
            href="/templates?batch=batch-3"
          ...
          >
            <span>Buka Template Batch 3</span>
